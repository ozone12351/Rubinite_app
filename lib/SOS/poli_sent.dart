...
class PoliSent extends StatelessWidget {
  const PoliSent({Key? key}) : super(key: key);
      ...
      child: Scaffold(
        ...
        body: Column(
          children: [
            ...
            const Padding(padding: EdgeInsets.symmetric(vertical: 45, horizontal: 0)),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      const Padding(padding: EdgeInsets.symmetric(vertical: 20, horizontal: 0)),
